...
```cpp linenums="1" hl_lines="34 38 41 54-62 65-72 76 88-102 104-122 133"
#include <NeoPDF.hpp>
#include <cassert>
#include <cmath>
#include <cstdio>
...
!!! note "Filling Grids that depend on Multiple Parameters"
...
```cpp linenums="1" hl_lines="106 112 115-125 128-135 138 146-160 162-180 191"
